...

{
	...
	$query2="select * from staff where id='".$ID."' and password='".$Enc_old_password."'";
	$res2=mysqli_query($con,$query2);
	if($row2=mysqli_fetch_array($res2))
	{
		$query1="update staff set password='".$Enc_new_password."' where id='".$ID."' and password='".$Enc_old_password."'";
