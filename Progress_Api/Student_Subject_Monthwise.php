...

{
	...
	// response Array
		...
		$To_Date  = date('Y-m-t 12:59:59', $timestamp); // A leap year!
...

		{
			...
			$query1="SELECT * FROM `attendance` WHERE `staff_id`='".$Staff_ID."' AND `class_id`='".$Class_ID."' AND `subject_id`='".$Subject_ID."' AND `type`='".$Type."' AND `batch_name`='".$Batch_name."' and `datetime` BETWEEN '".$From_Date."' AND '".$To_Date."'";
