...

{
	...
	$query2="select * from student where id='".$ID."' and password='".$Enc_old_password."'";
	//echo $query2;
	$res2=mysqli_query($con,$query2);
	if($row2=mysqli_fetch_array($res2))
	{
		$query1="update student set password='".$Enc_new_password."' where id='".$ID."' and password='".$Enc_old_password."'";
	//	echo $query1;
