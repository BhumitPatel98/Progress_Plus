...
import app.student.attendance.com.teacherapp.Activities.SplashActivity;
        ...
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                tempFileUri = FileProvider.getUriForFile(applicationContext,
                        "app.student.attendance.com.teacherapp.com.scanlibrary.provider", // As defined in Manifest
                        file);
            } else {
