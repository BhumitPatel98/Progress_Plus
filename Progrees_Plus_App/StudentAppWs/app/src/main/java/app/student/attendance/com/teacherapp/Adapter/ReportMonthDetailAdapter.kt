 ...
 */
class ReportMonthDetailAdapter(private var dataList: JSONArray, private var mainActivity: AppCompatActivity)
    : RecyclerView.Adapter<ReportMonthDetailAdapter.LectureViewHolder>() {
