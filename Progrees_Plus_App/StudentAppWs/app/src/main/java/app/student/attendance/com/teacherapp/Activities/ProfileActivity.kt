...
import app.student.attendance.com.teacherapp.API.ApiSettings.UploadFile
import app.student.attendance.com.teacherapp.App
import app.student.attendance.com.teacherapp.R
import app.student.attendance.com.teacherapp.Utility.*
import app.student.attendance.com.teacherapp.Utility.Utility.MY_PERMISSIONS_CAMERA
import app.student.attendance.com.teacherapp.Utility.Utility.MY_PERMISSIONS_REQUEST_READ_EXTERNAL_STORAGE
...
//            tv_changeprofile.setOnClickListener(View.OnClickListener { selectImage() })
        ...
        val stringRequest = object : StringRequest(Request.Method.POST, ApiSettings.STUDENT_EDIT_PROFILE,
                Response.Listener<String> { response ->
                    try {
                        ...
                        AlertDialogManager.showDialog(this@ProfileActivity, jsonObject.optString("Message"), "Ok", null, runner)
                    } catch (e: Exception) {
                    }
                },
            ...
            override fun getParams(): Map<String, String> {
                ...
                try {
                    ...
                    params.put("Student_ID", usersDetail.optString("Student_ID"))
                    ...
                    params.put("Parent_FirstName", edt_pfirst_name.text.toString())
                    params.put("Parent_LastName", edt_plast_name.text.toString())
                    if (urlUploaded != null)
    ...
    private fun setProfile(jsonObject: JSONObject) {
        try {
            ...
            edt_class_name.setText(jsonObject.optString("Class_Name"))
            edt_pfirst_name.setText(jsonObject.optString("Parent_First_Name"))
            edt_plast_name.setText(jsonObject.optString("Parent_last_Name"))
            edt_pemail.setText(jsonObject.optString("Parent_Email"))
            edt_pmobileno.setText(jsonObject.optString("Parent_Mobile"))
