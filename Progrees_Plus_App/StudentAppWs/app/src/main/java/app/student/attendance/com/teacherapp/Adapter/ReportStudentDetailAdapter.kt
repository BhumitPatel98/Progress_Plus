 ...
 */
class ReportStudentDetailAdapter(private var dataList: JSONArray, private var mainActivity: AppCompatActivity)
    : RecyclerView.Adapter<ReportStudentDetailAdapter.LectureViewHolder>() {
    ...
    override fun onBindViewHolder(holder: LectureViewHolder, position: Int) {
        try {
            ...
            holder.time.text =jsonObject.optString("Time")
