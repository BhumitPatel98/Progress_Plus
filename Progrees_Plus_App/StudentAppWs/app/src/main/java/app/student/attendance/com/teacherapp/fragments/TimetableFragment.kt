package app.student.attendance.com.teacherapp.fragments
...
import app.student.attendance.com.teacherapp.Adapter.TimetableAdapter
...
class TimetableFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        mainView = inflater.inflate(R.layout.fragment_timetable, null, false)
        setAdapter()
        return mainView
    }
