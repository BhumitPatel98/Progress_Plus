...
import app.teacher.attendance.com.teacherapp.Activities.AttendenceActivity
import app.teacher.attendance.com.teacherapp.Activities.MainActivity
 ...
 */
class DashboardAdapter(private var dataList: JSONArray, private var mainActivity: MainActivity)
    ...
    override fun onBindViewHolder(holder: LectureViewHolder, position: Int) {
        ...
        holder.attendance.setOnClickListener(View.OnClickListener {
            val intent = Intent(holder.attendance.context, AttendenceActivity::class.java)
            intent.putExtra("CLASS_DETAIL", jsonObject.toString())
