           ...
           <div class="card">
                 <div class="card-header">
                    ...
                    <div class="text-center">
                         <h5 style="font-size: 25px;color: #3760f7;">Notification</h5>
                    </div>

                     <div class="pull-left">
                      <a href='Add_Notification.php' class="btn btn-primary btn-outline-primary" style="font-weight: 600;">ADD Notification</a>
                     </div>
    ...
    function Display_Category()
       ...
       //   "<'row'<'col-sm-5'i><'col-sm-7'p>>",
            ...
            "drawCallback": function( settings ) {
                    ...
                    "ajax":{
                        url :"Get_Notification.php", // json datasource
