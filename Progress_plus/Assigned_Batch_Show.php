																		...
																		<div class="col-sm-8" style="margin: 0px">
																			...
																			<?php 
																				...
																				?>
																					...
																					<div class="form-group row">
																							<label class="col-sm-4 col-form-label  text-center">Batch Name:</label>
																							<div class="col-sm-8">
																								<div id="show_batch">
...
<![endif]-->
	...
	function check_batch()
	{
	 ...
	 function Display_Category(id2,b1)
        {
   ...
   //   "<'row'<'col-sm-5'i><'col-sm-7'p>>",
        ...
        "drawCallback": function( settings ) {
                ...
                "ajax":{
                    url :"Get_Batch_Show.php", // json datasource
                    type: "post", // method  , by default 
                    data:{"id":id2,"batch":b1},
...
e.preventDefault();
var id2=$("#class_name").val();
var b1 =$("#batch_name").val();
Display_Category(id2,b1);
});
	</script>
</body>
