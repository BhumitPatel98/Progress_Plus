...
<div class="modal fade" id="default-Modal_1" tabindex="-1" style="z-index: 55000" role="dialog" >
...
<div class="modal-body">
  <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                       <select name="class1" id="class1" required="" class="form-control" required>
...
<div class="form-group row">
                                    <label class="col-sm-4 col-form-label">File Name<span style="color: red;">*</span></label>
                                    <div class="col-sm-8">
                                       <input type="file" name="file" id="file" required="" class="form-control" required>
                                    </div>
                                </div> 
                                <div id="improt_error" style="display: none;"></div>                 
              </div>
           ...
           <div class="card">
                 <div class="card-header">
                    ...
                    <div class="text-center">
                         <h5 style="font-size: 25px;color: #3760f7;">Subject</h5>
                    </div>

                     <div class="pull-left">
                      <a href='#default-Modal'  data-toggle='modal' class="btn btn-primary btn-outline-primary" style="font-weight: 600;">ADD Subject</a>
                       <a href='#default-Modal_1'  data-toggle='modal'  class="btn btn-primary btn-outline-primary" style="font-weight: 600;">Import Subject</a>
                     </div>
...
<label class="col-sm-4 col-form-label">Class Name<span style="color: red;">*</span></label>
<div class="col-sm-8">
<select name="class_name" id="class_name" required="" class="form-control" required>
<option value="">Select Class</option>
<?php 
$query="select * from class";
$res=mysqli_query($con,$query);
...
<div class="form-group row">
<label class="col-sm-4 col-form-label">Subject Code<span style="color: red;">*</span></label>
<div class="col-sm-8">
<input type="text" class="form-control" id="subject_code" name="subject_code" placeholder="Subject Code" onblur="Check_code()" required>
...
<div class="form-group row">
    <label class="col-sm-4 col-form-label">Subject Type<span style="color: red;">*</span></label>
    <div class="col-sm-8">
<div class="checkbox-fade fade-in-primary">
<label>
<input type="checkbox" value="batch_wise" id="sub_type" name="sub_type" required>
<span class="cr">
    ...
    function Display_Category()
       ...
       //   "<'row'<'col-sm-5'i><'col-sm-7'p>>",
            ...
            "drawCallback": function( settings ) {
                    ...
                    "ajax":{
                        url :"Get_Subject.php", // json datasource
...
$(document).on("click", ".edit_model_btn", function () {
                ...
                $.ajax(
                        {   url: 'AddEdit_Subject.php',
                            ...
                            success: function(data)
                            {
                              ...
                              var class_name=split_hash[2];
                              var subject_code=split_hash[3];               
                              var subject_name=split_hash[4];
                              var attendance_type=split_hash[5];
                             ...
                             {
                                $("#sub_type").attr('checked', false); 
                             }
                             else
                             {
                                $("#sub_type").attr('checked', true);
                             }
                              $("#Action").val("EDIT"); 
                            }
                        });  
    ...
    $.ajax({
        ...
        success: function(data) {
        var split_hash = data.split("@@@");
        var improt_error = split_hash[0];
        var message1 = split_hash[1];
                if(message1.trim()=="Success") {        
                  var table = $('#res-config').DataTable();
                                  table.draw(); 
                $("#button_div").show();
                $("#ajax_loader").hide();
                ...
                //$("#Action").val("EDIT");
                $("#improt_error").show();
                $("#improt_error").html(improt_error);
            }
        },
        async: false
    });
...
$('#default-Modal_1').on('hidden.bs.modal', function () {
