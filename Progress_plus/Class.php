...
<h5 style="font-size: 25px;color: #3760f7;">Class</h5>
</div>

<div class="pull-left">
<a href='#default-Modal'  data-toggle='modal' class="btn btn-primary btn-outline-primary" style="font-weight: 600;">ADD Class</a>
</div>
...
<div class="col-sm-8">
<select name="department" id="department" required="" class="form-control" onchange="sem('dept')">
...
<div class="form-group row">
<label class="col-sm-4 col-form-label">Semester<span style="color: red;">*</span></label>
<div class="col-sm-8">
<select name="semester" id="semester" required="" class="form-control" onchange="sem('semt')">
<option value="">Select</option>
...
<div class="col-sm-8">
<select name="division" id="division" class="form-control" onchange="sem('divi')">
<option value="">Select</option>
...
<div class="col-sm-8">
<input type="text" class="form-control" id="class_name" name="class_name" value="" readonly>
</div>
</div>              
		...
		var divi=$("#division").val();
			var short_name="";
				...
				{   url: 'Edit_class.php',
					...
					{
						$("#class_name").val(data+" Sem"+semt+" "+divi);
					}
				});
...
"ajax":{
url :"Get_Class.php", // json datasource
...
var class_id=split_hash[1];
var dept_id=split_hash[2];
var semester=split_hash[3];
var division=split_hash[4];
var class_name=split_hash[5];
