           ...
           <div class="card">
                 <div class="card-header">
                    ...
                    <div class="text-center">
                         <h5 style="font-size: 25px;color: #3760f7;">Department</h5>
                    </div>

                     <div class="pull-left">
                      <a href='#default-Modal'  data-toggle='modal' class="btn btn-primary btn-outline-primary" style="font-weight: 600;">ADD Department</a>
                     </div>
...
<div class="form-group row">
                                    <label class="col-sm-4 col-form-label">Department Code<span style="color: red;">*</span></label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="department_code" name="department_code" placeholder="Department Code" onblur="Check_code()" required>
  ...
  <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label">Department Sort Name<span style="color: red;">*</span></label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="dept_sort_name" name="dept_sort_name" placeholder="Department Name" required>
                                    </div>
                                </div>                                  
              </div>
    ...
    function Display_Category()
       ...
       //   "<'row'<'col-sm-5'i><'col-sm-7'p>>",
            ...
            "drawCallback": function( settings ) {
                    ...
                    "ajax":{
                        url :"Get_Department.php", // json datasource
                ...
                $.ajax(
                        {   url: 'AddEdit_Department.php',
                            ...
                            success: function(data)
                            {
                              ...
                              var department_id=split_hash[1];
                              var department_code=split_hash[2];
                              var department_name=split_hash[3];
                              var dept_sort_name=split_hash[4];
                             
                              $("#department_code").val(department_code);
                              $("#department_name").val(department_name);
                              $("#dept_sort_name").val(dept_sort_name);
