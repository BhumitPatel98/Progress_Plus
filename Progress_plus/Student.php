           ...
           <div class="card">
                 <div class="card-header">
                    ...
                    <div class="text-center">
                         <h5 style="font-size: 25px;color: #3760f7;">Student</h5>
                    </div>
                      <style type="text/css">
                        .div-left{float: left;}
                     ...
                     <div class="div-left">
                      <a href='Add_Student.php' class="btn btn-primary btn-outline-primary" style="font-weight: 600;">ADD Student</a>
                      <a href='#default-Modal'  data-toggle='modal'  class="btn btn-primary btn-outline-primary" style="font-weight: 600;">Import Student</a>
                      
                     </div>
                     <div class="div-right">
                     <select name="class" id="class" data-column="0" required="" class="form-control">
...
<div class="modal fade" id="default-Modal" tabindex="-1" role="dialog">
  ...
  <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                       <select name="class1" id="class1" required="" class="form-control">
                                                                            <option value="">Select Class</option>
                                                                            <?php 
                                                                                $query="select * from class";
                                                                                $res=mysqli_query($con,$query);
...
<script type="text/javascript">
    ...
    function Display_Category()
       ...
       //   "<'row'<'col-sm-5'i><'col-sm-7'p>>",
            ...
            "drawCallback": function( settings ) {
                    ...
                    "ajax":{
                        url :"Get_Student.php", // json datasource
    ...
    $('#class').on( 'change', function () {   // for select box
