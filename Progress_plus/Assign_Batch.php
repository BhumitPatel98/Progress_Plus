																	...
																	<div class="row">
																		<div class="col-sm-8" style="margin: 0px">
																			...
																			<form id="form1" name="form1" method="post" enctype="multipart/form-data">
																				<div class="col-sm-12">
																					<h4 class="sub-title" style="color: #4881ff">Assign Batch:</h4>                                  
																						<div class="form-group row">
																							<label class="col-sm-4 col-form-label  text-center">Class Name:</label>
																							<div class="col-sm-8">
																								<select name="class_name" id="class_name" required="" class="form-control" onchange="check_batch()">
																			...
																			<?php 
																				...
																				?>
																					...
																					<div class="col-sm-12">
																					<h4 class="sub-title" style="color: #4881ff">Batch List</h4>
																					<div class="card-block">
																				 ...
																				 <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                            <div class="form-group row">
                                                                                                <label class="col-sm-4 col-form-label text-center">Assign Batch Name:</label>
                                                                                                <div class="col-sm-8">
                                                                                                	<div id="show_batch">
                                                                                                    <select name="batch_name" id="batch_name" required="" class="multiselect form-control">

																			<option value="">Select Btach Name</option>
...
<![endif]-->
	...
	<script type="text/javascript">
		...
		{
			var id1 = $("#class_name").val();
            $.ajax({
                type: "post",
                url: "Check.php",
                data: "id="+id1+"&Type=check_batch",
                success: function(data) {
                	Display_Category(id1);
                	$('#res-config_paginate').css("display", "none");
   ...
   //   "<'row'<'col-sm-5'i><'col-sm-7'p>>",
        ...
        "drawCallback": function( settings ) {
                ...
                "ajax":{
                    url :"Get_Student_Batch.php", // json datasource
...
e.preventDefault();
var classs =$("#batch_name1").val();
$("#button_div").hide();
$("#ajax_loader").show();
var formData = new FormData(this);
formData.append("BtachNM", classs);
$.ajax({
    type: "post",
    url: "AddEdit_Student_Batch.php",
    data: formData,
    cache: false,
    contentType: false,
    processData: false,
        ...
        if(data.trim()=="Success")
                           {
                            	...
                            	window.location="Assign_Batch.php";	
                           } 
    },
    async: false
});
