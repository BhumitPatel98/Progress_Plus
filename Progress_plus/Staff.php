...
<div class="pcoded-inner-content">
           ...
           <div class="card">
                 <div class="card-header">
                    ...
                    <div class="text-center">
                         <h5 style="font-size: 25px;color: #3760f7;">Staff</h5>
                    </div>
                      <style type="text/css">
                        .div-left{float: left;}
                     ...
                     <div class="div-left">
                      <a href='Add_Staff.php' class="btn btn-primary btn-outline-primary" style="font-weight: 600;">ADD Staff</a>
                      <a href='#default-Modal'  data-toggle='modal'  class="btn btn-primary btn-outline-primary" style="font-weight: 600;">Import Staff</a>
                     </div>
                     <div class="div-right">
                        <select name="department1" id="department1" data-column="0" required="" class="form-control">
  ...
  <div class="modal fade" id="default-Modal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
      ...
      <button type="submit" class="btn btn-primary btn-round"" id="btn_save" name="btn_save" value="upload">Save changes</button>
      </div>
    ...
    function Display_Category()
       ...
       //   "<'row'<'col-sm-5'i><'col-sm-7'p>>",
            ...
            "drawCallback": function( settings ) {
                    ...
                    "ajax":{
                        url :"Get_Staff.php", // json datasource
...
$('#department1').on( 'change', function () {   // for select box
