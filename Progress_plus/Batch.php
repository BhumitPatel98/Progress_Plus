           ...
           <div class="card">
                 <div class="card-header">
                    ...
                    <div class="text-center">
                         <h5 style="font-size: 25px;color: #3760f7;">Batch</h5>
                    </div>

                     <div class="pull-left">
                      <a href='#default-Modal'  data-toggle='modal' class="btn btn-primary btn-outline-primary" style="font-weight: 600;">ADD Batch</a>
                     </div>
...
<div class="form-group row">
  ...
  <div class="form-group row">
                                ...
                                <span style="color: orange;">Note:Enter The Batch Name Same As E.g(b1;b2;b3;)</span>                                
              </div>
    ...
    function Display_Category()
       ...
       //   "<'row'<'col-sm-5'i><'col-sm-7'p>>",
            ...
            "drawCallback": function( settings ) {
                    ...
                    "ajax":{
                        url :"Get_Batch.php", // json datasource
                ...
                $.ajax(
                        {   url: 'AddEdit_Batch.php',
                            ...
                            success: function(data)
                            {
                              ...
                              var batch_id=split_hash[1];
                              var class_id=split_hash[2];
                              var batch_name=split_hash[3];
