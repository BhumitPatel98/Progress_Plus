...
if (! empty($_FILES)) {
    ...
    $targetPath = $link_url.$Student_Path;
																	...
																	<div class="row">
																		<div class="col-sm-8" style="margin: 0px">
																			...
																			<form id="form1" name="form1" method="post" enctype="multipart/form-data">
																				<div class="col-sm-12">
																					<h4 class="sub-title" style="color: #4881ff">Upload Photo For Student:</h4>
																					<div id="photo" name="photo" class="dropzone" action="Upload_Photo_Student.php?action=save">
																					</div>
																				</div>
