                                                            ...
                                                            <div class="card">
                                                                <div class="card-header">
                                                                    ...
                                                                    <div class="text-center">
                                                                        <h5 style="font-size: 25px;color: #3760f7;">Exam</h5>
                                                                    </div>

                                                                    <div class="pull-left">
                                                                        <a href='#default-Modal' data-toggle='modal' class="btn btn-primary btn-outline-primary" style="font-weight: 600;">ADD Exam</a>
                                                                    </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form id="form1" name="form1" method="post">
                            <div class="modal-header">ADD EXAM</h4>
            ...
            <script type="text/javascript">
                function Display_Category() {
                    ...
                    var dataTable = $('#res-config').DataTable({
                        ...
                        "ajax": {
                            url: "Get_Exam.php", // json datasource
