                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <div class="text-center">
                                                    <h5 class="sub-title" style="font-size: 25px;color: #3760f7;">Staff</h5>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <form id="form1" name="form1" method="post">
                                                            <div class="col-sm-12">
                                                            	<h4 class="sub-title" style="color: #4881ff">Department Name:<span style="color: red;">*</span></h4>
                                                                <div class="form-group row">
                                                                    <div class="col-sm-11">
                                                                        <select name="department_name" id="department_name" required="" class="form-control">
                                                            ...
                                                            <div class="col-sm-12">
                                                                ...
                                                                <h4 class="sub-title" style="color: #4881ff">Staff Information</h4>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-7">
                                                                                <input type="text" class="form-control" name="email" id="email" placeholder="Email" data-validation="email" onblur="check_Email()" required>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-7">
                                                                                <input type="text" class="form-control" name="card_no" id="card_no" placeholder="Card No" required>
                                                                                <span class="messages"></span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-7">
                                                                                <input type="radio" class="form-radio" name="gender" id="gender1" value="Male" checked><label>Male</label>     
                                                                                <input type="radio" class="form-radio" name="gender" id="gender2" value="Female" ><label>Female</label>
                                                                                <span class="messages"></span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group row">
                                                                            <label class="col-sm-3 col-form-label">Experience:<span style="color: red;">*</span></label>
                                                                            <div class="col-sm-7">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group row">
                                                                            <label class="col-sm-3 col-form-label">Education:<span style="color: red;">*</span></label>
                                                                            <div class="col-sm-7">
...
$.ajax({
    ...
    success: function(data) {
        ...
        var card_no = split_hash[8];
        var birthdate = split_hash[9];
        var designation = split_hash[10];
        var joining_date = split_hash[11];
        var experience = split_hash[12];
        var education = split_hash[13];
        var address = split_hash[14];
        var city = split_hash[15];
        var state = split_hash[16];
        var zipcode = split_hash[17];
        var department = split_hash[18];
        var date = split_hash[19];
        var gender = split_hash[20];
        var status = split_hash[21];
